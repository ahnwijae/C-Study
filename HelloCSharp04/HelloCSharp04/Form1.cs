...
namespace HelloCSharp04
{
    public partial class Form1 : Form
    {
        ...
        {
            Hide();
            //new Form2("10!=1O").ShowDialog(); // 모달, Form2만 보일 것 -> 뒤에 코드 실행안하고 이 코드에서 실행이 멈춤
            new Form2("10!=1O").Show(); // 모달리스, 창이 둘 다 나타남 -> 코드 멈추지 않고 뒤에코드까지 실행
            Show();
        }

        private void button4_Click(object sender, EventArgs e)
        {
            // form창 안에 form 여러개 생성하기
            // 주식과 같은 프로그램에서 많이 쓰임
